...
getRouterConfigurations(load_router_infor);
function getRouterConfigurations(load_status) {
    // interface configuration
    if (load_status == "1") {
        var datapass = "router_ip_address="+router_data[0].router_ipaddr+"&router_username="+router_data[0].router_api_username+"&router_password="+router_data[0].router_api_password+"&router_port="+router_data[0].router_api_port;
        sendDataPost1("POST","/get_interface_config",datapass,cObj("interface_configs"),cObj("interface_conf"));
        sendDataPost1("POST","/get_internet_access",datapass,cObj("internet_access_method"),cObj("load_internet_access_methods"));
        sendDataPost1("POST","/get_supply_method",datapass,cObj("internet_distribution_method"),cObj("internet_distro_method"));
        sendDataPost1("POST","/wireless_settings",datapass,cObj("wireless_conf"),cObj("wireless_configuration"));
    }
}
cObj("edit_interfaces").onclick = function () {
    cObj("edit_interfaces_win").classList.remove("d-none");
    cObj("view_config").classList.add("d-none");
    getBridges();
}
cObj("interface_config_back").onclick = function () {
    cObj("edit_interfaces_win").classList.add("d-none");
    cObj("view_config").classList.remove("d-none");
    sendDataPost1("POST","/get_interface_config",datapass,cObj("interface_configs"),cObj("interface_conf"));
}
...
cObj("edit_net_access").onclick = function () {
    cObj("net_access_method").classList.add("d-none");
    cObj("edit_access_methods").classList.remove("d-none");
    step3();
}
cObj("back_to_internet_access").onclick = function () {
    cObj("net_access_method").classList.remove("d-none");
    cObj("edit_access_methods").classList.add("d-none");
    step3()
}
...
cObj("view_net_configurations").onclick = function () {
    cObj("reset_internet_distro").classList.add("d-none");
    cObj("view_internet_distros").classList.remove("d-none");
    sendDataPost1("POST","/get_supply_method",datapass,cObj("internet_distribution_method"),cObj("internet_distro_method"));
}
cObj("net_distro_modes").onclick = function () {
    cObj("reset_internet_distro").classList.remove("d-none");
    cObj("view_internet_distros").classList.add("d-none");
}
...
cObj("wireless_configs").onclick = function () {
    cObj("wireless_config_windows").classList.remove("d-none");
    cObj("wireless_int_conf").classList.add("d-none");
}
cObj("edit_wireless_configs").onclick = function () {
    cObj("wireless_config_windows").classList.add("d-none");
    cObj("wireless_int_conf").classList.remove("d-none");
}
