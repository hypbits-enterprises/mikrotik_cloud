...
function displayRecord(start, finish, arrays) {
    ...
    if(finish < total) {
        ...
        for (let index = start; index < finish; index++) {
                ...
                tableData+="<tr><th scope='row'>"+counter+"</th><td>" + arrays[index][5] +" "+status+"</td><td>" + arrays[index][4] +" "+ (arrays[index][9] != null ? " <a class='text-danger' href = 'https://www.google.com/maps/place/"+arrays[index][9]+"' target = '_blank'><u>Locate</u> </a>": "")+"</td><td>" + arrays[index][8]+" Client(s)" + "</td><td><a href='Router/View/" + arrays[index][3] + "' class='btn btn-sm btn-primary text-bolder ' data-toggle='tooltip' title='View this Router'><i class='ft-eye'></i> View</a></td></tr>";
                // tableData+="<tr><th scope='row'>"+counter+"</th><td>" + arrays[index][5] +" "+status+"</td><td>" + arrays[index][4] +" "+ (arrays[index][9] != null ? " <a class='text-danger' href = 'https://www.google.com/maps/place/"+arrays[index][9]+"' target = '_blank'><u>Locate</u> </a>": "")+"</td><td>" + arrays[index][8]+" Client(s)" + "</td><td><a href='Router/View/" + arrays[index][3] + "' class='btn btn-sm btn-primary text-bolder ' data-toggle='tooltip' title='View this Router'><i class='ft-eye'></i> View</a><a href='Router/Logs/" + arrays[index][3] + "' class='btn btn-sm btn-primary text-bolder mx-1 ' data-toggle='tooltip' title='View this routers logs'><i class='ft-activity'></i></a></td></tr>";
