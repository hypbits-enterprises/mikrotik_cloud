                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h6 class="text-primary"><strong>Enter Transaction Id <span class="invisible" id="interface_load"><i class="fas ft-rotate-cw fa-spin"></i></span></strong></h6>
                                        </div>
                                        <div class="col-md-8 row my-1">
                                            <div class="col-md-8">
                                                <input type="text" name="mpesa_id" id="mpesa_id" class="form-control" placeholder="M-Pesa Id">
                                            </div>
                                            <div class="col-md-4">
                                                <button type="button" id="mpesa_id_search" class="btn btn-primary">Search</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
