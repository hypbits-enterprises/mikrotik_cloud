...
<head>
    ...
    <title>Error 500 - Chameleon Admin - Modern Bootstrap 4 WebApp & Dashboard HTML Template + UI Kit</title>
                        ...
                        <div class="col-lg-4 col-md-6 col-10 p-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="row py-2 text-center">
                                    <div class="col-12">
                                        <a href="index.html" class="btn btn-white danger box-shadow-4"><i class="ft-home"></i> Back to Home</a>
                                    </div>
