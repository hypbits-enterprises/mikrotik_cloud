                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-6 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                <h2 class="error-code text-center mb-2 white">419</h2>
                                <h3 class="text-center white">Don`t panic, The page has expired click the home button.</h3>
                            </div>
                            <div class="card-content">
                                <div class="row py-2 text-center">
                                    <div class="col-12">
                                        <a href="/Dashboard" class="btn btn-white danger box-shadow-4"><i class="ft-home"></i> Back to Home</a>
                                    </div>
