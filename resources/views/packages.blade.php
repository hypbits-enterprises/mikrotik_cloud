...
<head>
    ...
    <title>Hypbits - Package Manager</title>
...
<body class="vertical-layout vertical-menu 2-columns  menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Package Manager</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Package Manager
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive" id="transDataReciever">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row">1</th>
                                                    <td>James Mugoh <span class="badge badge-success"> </span></td>
                                                    <td>1 Month Free Trial</td>
                                                    <td>Monthly</td>
                                                    <td>Kes 1,000</td>
    ...
    <!-- BEGIN CLIENT JS-->
    <script src="/theme-assets/js/core/packages.js"></script>
    <script>
