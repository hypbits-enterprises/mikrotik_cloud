                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-6 row">
                                        ...
                                        <div class="col-md-6">
                                            <p><strong>Amount to text: </strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>{{round($transaction_details[0]->transacion_amount/$client_data[0]->sms_rate)}} SMS(es)</p>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-lg-6 row">
                                        ...
                                        <div class="col-md-6">
                                            <p><strong>SMS Balance: </strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>{{$client_data[0]->sms_balance}} SMS(es)</p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>SMS Rates: </strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>Kes {{$client_data[0]->sms_rate}} <small>per</small> SMS</p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Client Account No: </strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>{{$client_data[0]->account_number}}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Client`s Location: </strong></p>
                                        </div>
                                        <div class="col-md-6">
                                            <p>{{$client_data[0]->client_location}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body row">
