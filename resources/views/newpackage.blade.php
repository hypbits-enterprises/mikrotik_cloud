...
<head>
    ...
    <title>Hypbits - New Billing Package</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">New Package</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"> New Package
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/register_package" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="payment_inetervals" class="form-control-label">Payment Intervals
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <label for="package_prices" class="form-control-label">Package Price</label>
                                                <input type="number" name="package_prices" id="package_prices"
                                                    class="form-control rounded-lg p-1"
                                                    placeholder="Package Price"
                                                    value="{{ session('package_prices') ? session('package_prices') : '' }}">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-6">
                                                @php
                                                    $btnText = "<i class=\"ft-plus\"></i> Add Package";
                                                    $otherClasses = "";
                                                    $btn_id = "";
                                                    $btnSize="sm";
                                                    $type = "submit";
                                                ...
                                                {{-- <button class="btn btn-success text-dark" {{$readonly}} type="submit"><i
                                                        class="ft-plus"></i> Add Package</button> --}}
                                            </div>
                                            <div class="col-md-6">
                                            </div>
                                        </div>
