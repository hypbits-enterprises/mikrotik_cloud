...
<head>
    ...
    <title>Hypbits - View Billing Package</title>
...
<body class="vertical-layout vertical-menu 2-columns  menu-expanded fixed-navbar" data-open="click"
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">View Package</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"> View Package
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-content collapse show">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 border-left border-secondary">
                                        ...
                                        <div class="container d-none" id="prompt_del_window">
                                            <p class="text-primary" ><strong>Are you sure you want to permanently delete this package?</strong></p>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="/delete_package/{{$packages[0]->package_id}}" class="btn btn-danger btn-sm" >Yes</a>
                                                </div>
                                                <div class="col-md-6">
                                                    <p class="btn btn-secondary btn-sm" id="delete_package_no">No</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    @if (session('data_success'))
                                        <p class="text-success">{{ session('data_success') }}</p>
                                    @endif
                                    ...
                                    <form action="/update_package" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                <label for="package_names" class="form-control-label">Package Name { {{$packages[0]->package_name ?? ''}} }</label>
                                                <input type="text" name="package_names" id="package_names"
                                                    class="form-control rounded-lg p-1"
                                                    placeholder="Package Name" required
                                                    value="{{$packages[0]->package_name ?? ''}}">
                                                    <input type="hidden" name="package_id" value="{{$packages[0]->package_id}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="free_trial_period" class="form-control-label">Free Trial Period { {{$packages[0]->free_trial_period ?? ''}} }</label>
                                                <select name="free_trial_period" id="free_trial_period" class="form-control rounded">
                                                    <option value="" hidden>Select Option</option>
                                                    <option {{$packages[0]->free_trial_period == "7 days" ? "selected" : ""}} value="7 days">7 Days</option>
                                                    <option {{$packages[0]->free_trial_period == "30 days" ? "selected" : ""}} value="30 days">30 Days</option>
                                                    <option {{$packages[0]->free_trial_period == "3 Months" ? "selected" : ""}} value="3 Months">3 Months</option>
                                                    <option {{$packages[0]->free_trial_period == "6 Months" ? "selected" : ""}} value="6 Months">6 Months</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="payment_inetervals" class="form-control-label">Payment Intervals { {{$packages[0]->payment_intervals}} }
                                                    </label>
                                                <select name="payment_inetervals" id="payment_inetervals" class="form-control">
                                                    <option value="" hidden>Select an option</option>
                                                    <option {{$packages[0]->payment_intervals == "7 days" ? "selected" : ""}} value="7 days">One week</option>
                                                    <option {{$packages[0]->payment_intervals == "1 month" ? "selected" : ""}} value="1 month">One Month</option>
                                                    <option {{$packages[0]->payment_intervals == "3 months" ? "selected" : ""}} value="3 months">3 Months</option>
                                                    <option {{$packages[0]->payment_intervals == "6 months" ? "selected" : ""}} value="6 months">6 Months</option>
                                                    <option {{$packages[0]->payment_intervals == "1 Year" ? "selected" : ""}} value="1 Year">1 Year</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="package_prices" class="form-control-label">Package Price { {{$packages[0]->amount_to_pay}} }</label>
                                                <input type="number" name="package_prices" id="package_prices"
                                                    class="form-control rounded-lg p-1"
                                                    placeholder="Package Price"
                                                    value="{{$packages[0]->amount_to_pay}}">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
    ...
    <script>
        ...
        prompt_delete.onclick = function () {
            prompt_delete.classList.add("d-none");
            var prompt_del_window = document.getElementById("prompt_del_window");
            prompt_del_window.classList.remove("d-none");
        }
        var delete_package_no = document.getElementById("delete_package_no");
        delete_package_no.onclick = function () {
            prompt_delete.classList.remove("d-none");
            var prompt_del_window = document.getElementById("prompt_del_window");
