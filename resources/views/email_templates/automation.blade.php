...
<body style="margin:0;padding:0;background-color:#ffffff;color:#000000;-webkit-text-size-adjust:100%;">
    ...
    <div class="u-row" style="margin:0 auto;min-width:320px;max-width:600px;overflow-wrap:break-word;word-wrap:break-word;word-break:break-word;background-color:transparent">
      <div style="border-collapse:collapse;display:table;width:100%;background-color:transparent">
        <div class="u-col u-col-100" style="max-width:320px;min-width:600px;display:table-cell;vertical-align:top">
          <div style="background-color:#f0f5f6;height:100%;width:100%!important">
            <div style="padding:30px 40px 40px;font-family:Arial,sans-serif;font-size:14px;line-height:1.6;color:#333333">
              {!! $htmlBody !!}
            </div>
          </div>
        </div>
      ...
      <div style="border-collapse:collapse;display:table;width:100%;background-color:transparent">
        <div class="u-col u-col-100" style="max-width:320px;min-width:600px;display:table-cell;vertical-align:top">
          <div style="background-color:#ecf0f1;height:100%;width:100%!important">
            <div style="padding:15px 40px 20px;font-family:Arial,sans-serif;font-size:12px;text-align:center;color:#666666;line-height:1.7">
              <p><a href="https://hypbits.com/" target="_blank" style="color:#0000ee;text-decoration:underline">hypbits.com</a> &nbsp;|&nbsp; The best ISP billing software in Kenya</p>
            </div>
          </div>
        </div>
      </div>
