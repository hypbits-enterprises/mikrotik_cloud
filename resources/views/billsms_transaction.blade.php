...
<head>
    ...
    <title>Hypbits - Client SMS Transactions</title>
...
<body class="vertical-layout vertical-menu 2-columns  menu-expanded fixed-navbar" data-open="click"
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">SMS Billing Transactions</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">SMS Billing Transactions
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    <script src="/theme-assets/js/core/billsms_transact.js"></script>
    <script>
