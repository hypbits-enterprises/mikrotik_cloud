...
<head>
    ...
    <title>Hypbits - Transactions Statistics</title>
...
<body class="vertical-layout vertical-menu 2-columns  menu-expanded fixed-navbar" data-open="click"
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Transactions Stats</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/Transactions">My Transactions</a>
                                </li>
                                <li class="breadcrumb-item active">Transactions Stats
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <a href="/Transactions" class="text-primary"><i class="ft-arrow-left"></i> Back to Transactions</a>
                                    <p class="card-text">View Transaction Cash flow.</p>
    ...
    <script>
        var transaction_stats_weekly = @json($transaction_stats_weekly);
        var transaction_records_weekly = @json($transaction_records_weekly);
        var transaction_stats_monthly = @json($transaction_stats_monthly);
        var transaction_records_monthly = @json($transaction_records_monthly);
        var transaction_yearly_stats = @json($transaction_yearly_stats);
        var transaction_yearly_records = @json($transaction_yearly_records);
    </script>
    <script src="/theme-assets/js/core/trans-stats.js"></script>
