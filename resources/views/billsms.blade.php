...
<head>
    ...
    <title>Hypbits - Billing SMS Manager</title>
...
<body class="vertical-layout vertical-menu 2-columns  menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="/theme-assets/images/backgrounds/02.jpg">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="{{showOption($priviledges,"Account and Profile")}} active"><a href="/Accounts"><i class="ft-lock"></i><span class="menu-title" data-i18n="">Account and Profile</span></a>
                </li>
            </ul>
        </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Billing SMS Manager</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Billing SMS Manager
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Clients SMS Table</h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body">
                                    {{-- <p>{{($client_data ?? '')}}</p> --}}
                                    <p class="card-text">- In this table below Client information is displayed. <br>- Add a new client by clicking the new button.</p>
                                    <p>Search options</p>
    ...
    <script>
        ...
        var package_name = @json($package_name ?? []);
        // here now you create the clients table
        // console.log(data);
    </script>
    <!-- BEGIN CLIENT JS-->
    <script src="/theme-assets/js/core/billsms.js"></script>
    <script>
