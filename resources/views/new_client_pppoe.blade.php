...
<head>
    ...
    <title>Hypbits - New Quick Register Clients - PPPoE Assignment</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">New Quick Client Register - PPPoE Assignment</h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route("quick_register.new_pppoe_client")}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-4">
