...
<body class="vertical-layout vertical-menu 2-columns  menu-expanded fixed-navbar" data-open="click"
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">{{ $RouterName ?? 'Null Router Name' }} Clients Details</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <a href="/Clients/Export" class="btn btn-infor"><i class="ft-arrow-left"></i> Back to
                                    router List</a>
                                <div class="card-body">
                                    <div class="container">
                                        <p class="card-text">- The table below displays clients connected to
                                            <b>{{ $RouterName ?? 'Null Router Name' }}</b>.
                                            <br>- In this section you will be able to import data from your database to your
                                            router. <br>
                                            - You will be able to see all your clients data if they match with the data
                                            present in your router <br>
                                            - If the router data natches the data in your database a tick {<span
                                                class="text-success text-bolder text-lg"><i
                                                    class="ft-check"></i></span>} will be attached to the data. <br>
                                            - If the router data does not match the data in you database a {<span
                                                class="text-danger text-bolder text-lg"><i
                                                    class="ft-x"></i></span>} will be displayed <br>
                                            - If the router data displays an {<span
                                                class="text-danger text-bolder text-lg"><i
                                                    class="ft-x"></i></span>} sync the data and it will be changed accordingly by the system
                                            to your router
                                        </p>
                                        <p><strong>Note:</strong></p>
                                        <p>- Its only one way from the database to your router<br>- The first table is for <b>Static Assignment</b> and the Second one is for <b>PPPoE Assignment</b></p>
                                        <p><span class="text-bold-600">Client Export Table | Static Assignment:</span></p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <a href="/Clients/ExportAll/{{ $router_id }}"
                                                    class="btn btn-primary"><i class="ft-refresh-ccw"></i> Sync All</a>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Client Name</th>
                                                        <th>Ip Address </th>
                                                        <th>Default GW/Mask</th>
                                                        <th>Target Address (Queues)</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td>Hillary Developer <span class="badge badge-success"> </span>
                                                        </td>
                                                        <td>10.10.30.0 <span class="text-success text-bolder text-lg"><i
                                                                    class="ft-check"></i></span></td>
                                                        <td>10.10.30.1/24 <span class="text-success text-bolder text-lg"><i
                                                                    class="ft-check text-bolder"></i></span></td>
                                                        <td>10.10.30.0 <span class="text-success text-bolder text-lg"><i
                                                                    class="ft-check text-bolder"></i></span></td>
                                                        <td>5M/5M <span class="text-success text-bolder text-lg"><i
                                                                    class="ft-check text-bolder"></i></span></td>
                                                        <td><a href="#" class="btn btn-sm btn-primary text-bolder"
                                                                data-toggle="tooltip" title="Sync Client Information"><i
                                                                    class="ft-refresh-ccw"></i></a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td>Hillary Developer <span class="badge badge-danger"> </span>
                                                        </td>
                                                        <td>10.10.30.0 <span class="text-danger text-bolder text-lg"><i
                                                                    class="ft-x"></i></span></td>
                                                        <td>10.10.30.1/24 <span class="text-danger text-bolder text-lg"><i
                                                                    class="ft-x text-bolder"></i></span></td>
                                                        <td>10.10.30.0 <span class="text-danger text-bolder text-lg"><i
                                                                    class="ft-x text-bolder"></i></span></td>
                                                        <td>5M/5M <span class="text-danger text-bolder text-lg"><i
                                                                    class="ft-x text-bolder"></i></span></td>
                                                        <td><a href="#" class="btn btn-sm btn-primary text-bolder"
                                                                data-toggle="tooltip" title="Sync Client Information"><i
                                                                    class="ft-refresh-ccw"></i></a></td>
                                    ...
                                    <hr>
                                    <div class="container">
                                        <p><span class="text-bold-600">Client Export Table | PPPoE Assignment:</span></p>
                                        @if (session('success_router'))
                                            <p class='text-success'>{{ session('success_router') }}</p>
                                        @endif
                                        @if (session('error_router'))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                <input type="text" name="searchkey_ppoe" id="searchkey_ppoe"
                                                    class="form-control rounded-lg p-1" placeholder="Search here ..">
                                            </div>
                                            <div class="col-md-6 form-group"></div>
                                        </div>
                                        <div class="table-responsive" id="transDataReciever_ppoe">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                        ...
                                        <nav aria-label="Page navigation example" id="tablefooter_ppoe">
                                            <ul class="pagination" id="datatable_paginate_ppoe">
                                                <li class="page-item" id="tofirstNav_ppoe">
                                                    <a class="page-link" href="#" aria-label="Fisrt">
                                                        <span aria-hidden="true">&laquo; &laquo;</span>
                                                        <span class="sr-only">First</span>
                                                    </a>
                                                </li>
                                                <li class="page-item" id="toprevNac_ppoe">
                                                    <a class="page-link" href="#" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                        <span class="sr-only">Previous</span>
                                                    </a>
                                                ...
                                                <li class="page-item"><button disabled class="page-link"
                                                        id="pagenumNav_ppoe">Page: 1</button></li>
                                                <li class="page-item">
                                                    <a class="page-link" href="#" aria-label="Next" id="tonextNav_ppoe">
                                                        <span aria-hidden="true">&raquo;</span>
                                                        <span class="sr-only">Next</span>
                                                    </a>
                                                </li>
                                            ...
                                            <p class="card-text text-xxs">Showing from <span class="text-primary"
                                                    id="startNo_ppoe">1</span> to <span class="text-secondary"
                                                    id="finishNo_ppoe">10</span> records of <span id="tot_records_ppoe">56</span></p>
                                        </nav>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        var client_information_static = @json($client_information_static ?? '');
        // console.log(client_information_static);
        var client_information_pppoe = @json($client_information_pppoe ?? '');
    </script>
    <script src="/theme-assets/js/core/export2.js" type="text/javascript"></script>
    <script src="/theme-assets/js/core/export2_ppoe.js" type="text/javascript"></script>
